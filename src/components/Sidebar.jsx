...
export default function Sidebar({
  ...
  return (
      <div
          className={`h-full bg-white border-r border-gray-200 px-4 pt-4 pb-2 flex flex-col transition-all duration-300 text-sm text-gray-800 ${
              isSidebarOpen ? "w-64 opacity-100" : "w-0 opacity-0"
          }`}
      >
        {/* Historique */}
        <h2 className="text-sm font-semibold mb-3 text-gray-500 tracking-wide uppercase">
          Historique
        </h2>
        ...
        {/* Section Toolkit */}
        <div className="mt-6">
          <h2 className="text-sm font-semibold mb-2 text-gray-500 tracking-wide uppercase">
            Toolkit
          </h2>
          <button
